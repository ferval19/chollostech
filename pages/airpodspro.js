            ...
            <div>
              ...
              <div class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden hidden">
                <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                  ...
                  <div class="px-2 pt-2 pb-3 space-y-1 hidden">
                    <a
                      href="#"
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div class="sm:text-center lg:text-left">
                ...
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mt-2">
                  <span class="block xl:inline">Apple </span>
                ...
                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div class="rounded-md shadow">
                    <a
                      ...
                      class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-black bg-yellow-400 hover:bg-yellow-300 md:py-4 md:text-lg md:px-10"
                    >
                      Comprar en Amazon
                    </a>
                  </div>
